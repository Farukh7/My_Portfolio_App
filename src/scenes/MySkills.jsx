      ...
      <div className="md:flex md:justify-between md:gap-16 mt-32">
        ...
        >
          ...
          <p className="mt-10 mb-7">
            ...
            <ul>
              <li>
                <b className="font-semibold">Frontend:</b> HTML, CSS,
                JavaScript, React.js
              </li>
              <li>
                <b className="font-semibold">Backend:</b> Node.js, Express.js{" "}
              </li>
              <li>
                <b className="font-semibold">Database:</b> SQL, MongoDB
              </li>
              <li>
                <b className="font-semibold">Tools & Platforms:</b> Git, GitHub,
                Visual Studio Code
              </li>
              <li>
                <b className="font-semibold">Others:</b> SAP ABAP (exposure),
